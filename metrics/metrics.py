...
from metrics import mscoco_rouge
import numpy as np
...
if __name__ == "__main__":
    ref = ["I am working in NLP at Beihang university!", "hah xixi heihei"]
    hyp = ["I am working in NLP at Beihang", "hah xixi heihei oo"]
    # bleu = bleu(references=ref, hypotheses=hyp)
    # print(bleu)
